(function() {
  ...
  Seeds = (function() {
    ...
    Seeds.prototype.beacon = function() {
      this.grid.pointAt(40, 40).seed();
      this.grid.pointAt(50, 50).seed();
      this.grid.pointAt(60, 50).seed();
      this.grid.pointAt(60, 40).seed();
      this.grid.pointAt(60, 30).seed();
      return this.grid;
    };
    return Seeds;
  })();
  $(document).ready(function() {
    return new Game(new Seeds(new Grid(300, 300)).beacon());
  });
}).call(this);
